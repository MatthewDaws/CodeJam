...
class Light:
    ...
    def distance(one, two):
        return math.sqrt( (one.row - two.row)*(one.row - two.row) + (one.col - two.col)*(one.col - two.col) )
    ...
    def find_next_intersection(self):
        ...
        for line in hm.all_lines:
            ...
            if hit and t > 0 and 0 < s and s < 1:
